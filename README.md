...
|-----------|-------------|--------|---------|
| [**azd-app**](https://github.com/jongio/azd-app) | Run Azure apps locally with auto-dependencies, real-time dashboard, and AI-powered debugging via MCP | v0.15.2 | [🌐](https://jongio.github.io/azd-app/) |
