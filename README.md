...
|-----------|-------------|--------|---------|
| [**azd-app**](https://github.com/jongio/azd-app) | Run Azure apps locally with auto-dependencies, real-time dashboard, and AI-powered debugging via MCP | v0.12.7 | [🌐](https://jongio.github.io/azd-app/) |
| [**azd-copilot**](https://github.com/jongio/azd-copilot) | AI-powered Azure development with 16 agents, 29 Azure skills, and MCP server integration | v0.1.9 | [🌐](https://jongio.github.io/azd-copilot/) |
