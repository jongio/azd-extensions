...
|-----------|-------------|--------|---------|
| [**azd-app**](https://github.com/jongio/azd-app) | Run Azure apps locally with auto-dependencies, real-time dashboard, and AI-powered debugging via MCP | v0.13.0 | [🌐](https://jongio.github.io/azd-app/) |
...
| [**azd-rest**](https://github.com/jongio/azd-rest) | Make authenticated REST API calls to Azure with automatic scope detection and token management | v0.4.2 | [🌐](https://jongio.github.io/azd-rest/) |
