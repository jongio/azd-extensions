...
| [**azd-rest**](https://github.com/jongio/azd-rest) | Make authenticated REST API calls to Azure with automatic scope detection and token management | v0.4.0 | [🌐](https://jongio.github.io/azd-rest/) |
